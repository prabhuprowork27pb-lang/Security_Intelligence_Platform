...
export const SignupEmail = ({ recipient, confirmationUrl }: SignupEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Confirm your SIP™ access</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={h1}>Confirm your SIP™ access</Heading>
        <Text style={text}>
          Welcome to Security Intelligence Platform™. To activate your account for <strong style={{ color: '#0D162A' }}>{recipient}</strong>, please verify your email below.
        </Text>
        ...
        <Hr style={hr} />
        <Text style={footer}>
          If you didn't create a Security Intelligence Platform™ account, you can safely ignore this message.
        </Text>
