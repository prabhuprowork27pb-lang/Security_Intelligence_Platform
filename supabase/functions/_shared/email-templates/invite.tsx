...
export const InviteEmail = ({ confirmationUrl }: InviteEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to Security Intelligence Platform™</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          You've been invited to join Security Intelligence Platform™ — consulting-grade operational intelligence for modern security leadership. Accept the invitation below to activate your access.
        </Text>
